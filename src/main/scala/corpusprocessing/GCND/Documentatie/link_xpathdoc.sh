...
perl -pe 's/(<table.*?>)/$1<colgroup><col width="30%"><col width="70%"><\/colgroup>/' /tmp/dinges2.html | perl gentoc.pl > /tmp/dinges3.html

cp /tmp/dinges3.html dialectconstructies.html
pandoc dialectconstructies.html -o dialectconstructies.pdf --css=style.css
